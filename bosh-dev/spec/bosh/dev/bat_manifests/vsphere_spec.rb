require 'spec_helper'
require 'bosh/dev/bat_manifests/vsphere'
require 'tempfile'
require 'yaml'

describe Bosh::Dev::BatManifests::Vsphere do
  ...
  subject { Bosh::Dev::BatManifests::Vsphere.new(env) }
  ...
  describe '#generate' do
    ...
    it 'writes the yaml' do
      ...
      Tempfile.open('bat_output') do |output|
        subject.generate(template_path, output.path, director_uuid)
